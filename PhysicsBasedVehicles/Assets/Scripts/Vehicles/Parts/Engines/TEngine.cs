...
public abstract class TEngine : VehiclePart
{
    [Header("Engine")]
    ...
    public virtual void AddForces() {
        Vector3 worldCOM = transform.position + transform.TransformDirection(centerOfMass);
